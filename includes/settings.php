...
if ( isset($_POST['production_url']) ) :
	...
	if ( $_POST['production_url'] == '' ) {
		...
		$host = $this->lmfp_sanitize_trim_check( $_POST['production_url'] );
...
echo "<div class=\"notice notice-success\"><p>Defined constant is set - <code>define ( 'LOAD_MEDIA_FROM_PRODUCTION_URL', '" . LOAD_MEDIA_FROM_PRODUCTION_URL . "' );</code>. Settings cannot be updated.</p></div>";
				...
				<tr>
					...
					<td>
						<input type="text" name="production_url" id="production-url"
							size="50"
							value="<?php echo $production_url; ?>"
							<?php disabled( defined( 'LOAD_MEDIA_FROM_PRODUCTION_URL' ) ); ?> class="regular-text code<?php echo $wp_home_class; ?>" />
							<br />
